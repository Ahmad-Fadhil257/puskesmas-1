...
@section('title', 'Edit Layanan - Puskesmas CareLink')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        <div class="card-header border-bottom py-3">
            <h5 class="mb-0 fw-bold">Edit Data Layanan Medis</h5>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('variant') is-invalid @enderror" id="variant" name="variant" required>
                            <option value="default" {{ old('variant', $layanan->variant) == 'default' ? 'selected' : '' }}>Standar (Abu-abu / Putih)</option>
                            <option value="featured" {{ old('variant', $layanan->variant) == 'featured' ? 'selected' : '' }}>Unggulan (Hijau Gelap)</option>
                            <option value="emergency" {{ old('variant', $layanan->variant) == 'emergency' ? 'selected' : '' }}>Darurat (Merah dengan Tombol)</option>
                        </select>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i id="iconPreview" class="{{ old('icon', $layanan->icon ?? 'bx bx-plus-medical') }} fs-4"></i></span>
                            <input type="text"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('btn_link', $layanan->btn_link) }}"
