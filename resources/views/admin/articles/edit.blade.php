            ...
            <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="category" id="category" list="categoryDatalistEdit" class="form-control @error('category') is-invalid @enderror" placeholder="Pilih atau ketik kategori..." value="{{ old('category', $article->category) }}" required>
                        <datalist id="categoryDatalistEdit">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="14" required>{{ old('content', $article->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
