...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold py-1 mb-1" style="color:#0A5C45;">
            <i class="bx bx-plus-circle me-2"></i>Tambah Data Kunjungan
        </h4>
...
<div class="card border-0 shadow-sm" style="max-width:560px;">
    <div class="card-body p-4">
        <p class="text-muted small mb-4">
            ...
            Jika data untuk bulan yang dipilih sudah ada, data akan diperbarui otomatis.
        </p>

        <form action="{{ route('admin.statistik.kunjungan.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah_kunjungan" class="form-control @error('jumlah_kunjungan') is-invalid @enderror"
                       value="{{ old('jumlah_kunjungan', 0) }}" min="0" required>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="number" name="kunjungan_baru" class="form-control @error('kunjungan_baru') is-invalid @enderror"
                           value="{{ old('kunjungan_baru', 0) }}" min="0" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="kunjungan_lama" class="form-control @error('kunjungan_lama') is-invalid @enderror"
                           value="{{ old('kunjungan_lama', 0) }}" min="0" required>
