...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold py-1 mb-1" style="color:#0A5C45;">
            <i class="bx bx-plus-circle me-2"></i>Tambah Data Penyakit
        </h4>
...
<div class="card border-0 shadow-sm" style="max-width:640px;">
    <div class="card-body p-4">
        <form action="{{ route('admin.statistik.penyakit.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_penyakit" class="form-control @error('nama_penyakit') is-invalid @enderror"
                       value="{{ old('nama_penyakit') }}" placeholder="Contoh: Hipertensi (Tekanan Darah Tinggi)" required>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" name="jumlah_kasus" class="form-control @error('jumlah_kasus') is-invalid @enderror"
                           value="{{ old('jumlah_kasus', 0) }}" min="0" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kode_icd" class="form-control @error('kode_icd') is-invalid @enderror"
                           value="{{ old('kode_icd') }}" placeholder="Contoh: I10" maxlength="20">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="urutan" class="form-control @error('urutan') is-invalid @enderror"
                           value="{{ old('urutan', 1) }}" min="1" max="100" required>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="color" name="warna" id="colorPicker" class="form-control form-control-color"
                               value="{{ old('warna', '#0A5C45') }}" title="Pilih warna bar chart" style="width:50px;">
                        <input type="text" id="colorText" class="form-control" value="{{ old('warna', '#0A5C45') }}"
