...
class About extends Model
{
    ...
    public static function getActive()
    {
        return static::where('is_active', true)->first() ?: static::firstOrCreate([], [
            ...
            'title' => 'Puskesmas Sukaluyu Menciptakan Pelayanan Aman, Kesehatan Adalah Prioritas Kami',
            'description' => 'Puskesmas Sukaluyu menyediakan layanan kesehatan berkualitas tinggi dengan dokter berpengalaman, layanan gawat darurat, dan dukungan sepanjang waktu. Mitra tepercaya Anda untuk hidup yang lebih sehat.',
            'image_main' => null,
            'image_accent' => null,
            ...
            'misi_text' => 'Puskesmas Sukaluyu menghadirkan layanan ahli yang berfokus pada pasien, didukung oleh teknologi canggih dan layanan 24/7, serta berorientasi pada kesehatan dan kesejahteraan.',
            'is_active' => true,
        ]);
    }
}
